//===-- ov2640_regs.h — OV2640 JPEG init register tables (8-bit reg/val) ----===//
//
// Canonical ArduCAM OV2640 JPEG tables. {0xff,0xff} ends a table; {0xff,0x00/01}
// are bank selects. VERIFY against the official ArduCAM source if it misbehaves.
//
//===----------------------------------------------------------------------===//
...
struct ov2640_reg { uint8_t reg; uint8_t val; };

static const struct ov2640_reg OV2640_JPEG_INIT[] = {
...
static const struct ov2640_reg OV2640_640x480_JPEG[] = {

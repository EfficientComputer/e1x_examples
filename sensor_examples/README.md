...
If you haven't already, please make sure you've set up your board and development environment using our [Evaluation Kit Setup Instructions](https://docs.efficient.computer/evk/sdk-setup/linux). Please note that this this project does not support our Cloud EVK.
...
This will produce .bin files for flashing in `../bld/<app>/scalar/<app>.bin`
...
To flash an app to the EVK, make sure your BOOT switches on the board are set to `101` and run the following command from an app's scalar folder where the .bin is contained:

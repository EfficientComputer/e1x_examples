...
A vectorized version of the single-channel 3x3 2D convolution for the Electron E1 general-purpose processor. It computes the same result as the base `conv3x3` example but packs the arithmetic into SIMD dot products.

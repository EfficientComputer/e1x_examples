...
A floating-point version of the dense matrix-vector multiply (`z = A · b`) for the Electron E1 general-purpose processor. It computes the same operation as the base `dmv` example but on floating-point data instead of integers.

...
// The bellow is baked into the structure of 802.11 rate 1/2 code. Could vary
// for other codes.
#define MAX_CHECK_NODE_NNZ 8

// 802.11 parity-check (H) and generator (G) matrix data, generated by
// generate_80211_matrices.py

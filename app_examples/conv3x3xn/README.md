...
This example computes a **multi-channel 3x3 convolution** on the Electron E1x general-purpose processor. It convolves a 3x3 filter over every input channel and sums the results across channels, which is a full convolutional layer.

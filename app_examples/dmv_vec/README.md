...
A vectorized version of the dense matrix-vector multiply (`z = A · b`) for the Electron E1x general-purpose processor. It computes the same result as the base `dmv` example but packs the arithmetic into SIMD dot products.

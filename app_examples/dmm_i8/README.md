...
An int8 version of the dense matrix multiply (`Z = A * B`) for the Electron E1x general-purpose processor. It computes the same operation as the base `dmm` example but on 8-bit integer inputs, with a quantization step applied to the results.

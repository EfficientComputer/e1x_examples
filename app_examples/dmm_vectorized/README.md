...
A vectorized version of the dense matrix multiply (`Z = A * B`) for the Electron E1 general-purpose processor. It computes the same result as the base `dmm` example but packs the arithmetic into 16-bit SIMD dot products.

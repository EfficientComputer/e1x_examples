...
This example computes **square roots** using Newton-Raphson iteration on the Electron E1 general-purpose processor. It refines a floating-point estimate through a fixed number of iterations, showing how an iterative numerical kernel maps onto the Fabric architecture.

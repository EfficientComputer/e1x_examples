...
This example computes a **finite impulse response (FIR) filter** on the Electron E1x general-purpose processor. It is a compact, compute-dense signal-processing kernel used to show how a sliding-window dot product maps onto the Fabric architecture.

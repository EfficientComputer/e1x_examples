...
This example computes a **depthwise 3x3 convolution** on the Electron E1 general-purpose processor. It applies one independent 3x3 filter to each input channel, a pattern that dominates the compute of MobileNet-style convolutional networks.
